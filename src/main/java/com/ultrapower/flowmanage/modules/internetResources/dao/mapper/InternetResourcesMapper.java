package com.ultrapower.flowmanage.modules.internetResources.dao.mapper;
...
public interface InternetResourcesMapper {
	//查询TOP10网站域名总数统计
	...
	int findDomainLibraryRowCount(@Param("webName")String webName, @Param("domainName")String domainName, @Param("ip")String ip, @Param("district")String district) throws Exception;
	//根据网站名称、域名、IP地址、归属区域查询域名库列表
	List<Map<String, String>> findDomainLibraryTable(@Param("webName")String webName, @Param("domainName")String domainName, @Param("ip")String ip, @Param("district")String district,@Param("pageNo")int pageNo, @Param("pageSize")int pageSize) throws Exception;
